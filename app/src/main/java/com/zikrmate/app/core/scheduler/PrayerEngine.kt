...
import com.zikrmate.app.core.prayer.PrayerCalculator
...
import com.zikrmate.app.core.util.PrayerRuntimeState
...
object PrayerEngine {
    ...
    private suspend fun syncAlarmsInternal(context: Context, reason: String) {
        ...
        val notificationManager = com.zikrmate.app.core.notification.PrayerNotificationManager
            .getInstance(context)
    ...
    suspend fun onPrayerAlarmFiredSync(
        ...
        if (azanMode == AzanMode.FULL_SOUND) {
            com.zikrmate.app.core.audio.AzanPlaybackService.start(appContext, prayerName)
        }
